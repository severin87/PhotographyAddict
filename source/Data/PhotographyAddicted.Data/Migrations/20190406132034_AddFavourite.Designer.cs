...
namespace PhotographyAddicted.Data.Migrations
{
    ...
    [Migration("20190406132034_AddFavourite")]
            ...
            modelBuilder.Entity("PhotographyAddicted.Data.Models.Image", b =>
                {
                    ...
                    b.Property<string>("FavouriteImageId");

                    b.Property<int?>("FavouriteImageId1");
            ...
            modelBuilder.Entity("PhotographyAddicted.Data.Models.FavouriteImage", b =>
                {
                    b.HasOne("PhotographyAddicted.Web.Areas.Identity.Data.PhotographyAddictedUser", "PhotographyAddictedUser")
                        .WithOne("FavouriteImage")
                        .HasForeignKey("PhotographyAddicted.Data.Models.FavouriteImage", "PhotographyAddictedUserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("PhotographyAddicted.Data.Models.Image", b =>
                {
                    b.HasOne("PhotographyAddicted.Data.Models.FavouriteImage", "FavouriteImage")
                        .WithMany("Images")
                        .HasForeignKey("FavouriteImageId1");
